--- ### Git LUA API
--
-- This module can be loaded with `local git = require "vimsharp.utils.git"`
--
-- @module vimsharp.utils.git
...
--- Run a git command from the "repos" directory
-- @param args the git arguments
-- @return the result of the command or nil if unsuccessful
function git.cmd(args, ...)
  return require("plugins.NeovimUtils").cmd("git -C " .. vim.fn.getenv("repos") .. " " .. args, ...)
end

--- Check if able to reach the `git` command
